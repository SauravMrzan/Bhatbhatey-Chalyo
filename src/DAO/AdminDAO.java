...
public class AdminDAO {
    ...
    public boolean registerAdmin(RegisterModel admin) throws SQLException {
        String sql = "INSERT INTO admin (username, password, contact, email, gender, NID) VALUES (?, ?, ?, ?, ?, ?)";
...
public boolean isCitizenshipIdTaken(String citizenshipId) throws SQLException {
    String sql = "SELECT COUNT(*) AS count FROM admin WHERE NID = ?";
    try (Connection conn = Database.getConnection();
         PreparedStatement stmt = conn.prepareStatement(sql)) {
